...
class amostra_produto_marca_fase_model {
    ...
    public function getCod_fase() {
        return $this->cod_fase;
    }

    public function setCod_fase($cod_fase) {
    ...
    public function getMarca_nome() {
        return $this->marca_nome;
    }

    public function setMarca_nome($marca_nome) {
    ...
    public function getFase_nome() {
        return $this->fase_nome;
    }

    public function setFase_nome($fase_nome) {
