...
function paginadorTecla(cont){
	if(cont<=numitens){
		...
		$('#paginador').html('');
		if(pagina!=1){
			$('#paginador').append('<li><a href="#" onclick="getitensTecla('+(pagina-1)+', '+numitens+')">Página Anterior</a></li>');
		}
		...
		if(pagina!=qtdpaginas){
			$('#paginador').append('<li><a href="#" onclick="getitensTecla('+(pagina+1)+', '+numitens+')">Próxima Página</a></li>');
		}
	}
}
...
function paginador(cont){
	if(cont<=numitens){
		...
		$('#paginador').html('');
		if(pagina!=1){
			$('#paginador').append('<li><a href="#" onclick="getitens('+(pagina-1)+', '+numitens+')">Página Anterior</a></li>');
		}
		...
		if(pagina!=qtdpaginas){
			$('#paginador').append('<li><a href="#" onclick="getitens('+(pagina+1)+', '+numitens+')">Próxima Página</a></li>');
		}
	}
}
